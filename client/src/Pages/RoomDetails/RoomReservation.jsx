...
const RoomReservation = ({ roomData }) => {
  ...
  return (
    <div className="bg-white border-[1px] border-green-500 overflow-hidden rounded-md w-full">
      ...
      <hr />
      <div className="flex flex-row items-center justify-between p-4 font-bold text-lg bg-green-500">
        <div>Total</div>
        <div>${totalPrice}</div>
      </div>
      <BookingModal
